...
Some examples that could really utalize parallel computing would be epidemiology studies using clusters to trace and simulate spread of an infectious disease. Modeling a simulation of climate change how the increase of PM 2.5 concentrations fluctuate and the albedo effects of the ice caps melting.
