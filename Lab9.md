...
Some examples that could really utalize parallel computing would be
epidemiology studies using clusters to trace and simulate spread of an
infectious disease. Modeling a simulation of climate change how the
increase of PM 2.5 concentrations fluctuate and the albedo effects of
...
my_boot <- function(dat, stat, R, ncpus = 1L) {
  ...
  # STEP 2: Set up (export data if needed)
